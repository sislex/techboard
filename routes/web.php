...
Route::post('/api/favorites', 'GoodsController@addToFavorites');
Route::post('/api/get-all-favorites', 'GoodsController@getAllFavorites');
Route::get('/api/get-all-favorites', 'GoodsController@getAllFavorites');
Route::get('/api/favorites', 'GoodsController@addToFavorites');
